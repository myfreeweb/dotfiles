#!/bin/sh
# Base16 Palenight - Shell color setup script
...
color05="FF/86/9A" # Base 0E - Magenta
color06="89/DD/FF" # Base 0C - Cyan
color07="BF/C7/D5" # Base 05 - White
color08="2C/32/3C" # Base 03 - Bright Black
...
color15="CF/D7/E5" # Base 07 - Bright White

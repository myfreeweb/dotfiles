#!/bin/sh
# Base16 Pencil - Shell color setup script
# Greg V (https://unrelenting.technology)
# github.com/reedes github.com/mattly -- vim-colors-pencil
...
color00="2A/2A/2A" # Base 00 - Black
color01="EF/B0/81" # Base 08 - Red
color02="B8/E0/9F" # Base 0B - Green
color03="D3/C4/20" # Base 0A - Yellow
color04="B5/D6/EA" # Base 0D - Blue
color05="FB/A0/CA" # Base 0E - Magenta
color06="20/BB/FC" # Base 0C - Cyan
...
color_foreground=$color05
color_background=$color00
color_cursor=$color06
